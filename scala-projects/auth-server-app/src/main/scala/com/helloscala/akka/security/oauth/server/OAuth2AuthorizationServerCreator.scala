...
//
//  def createRegisteredClientRepository(
//      implicit
...
//
//  def createOAuth2AuthorizationService(
//      implicit
//      reactor: RecipientRef[SpawnProtocol.Command],
//      scheduler: Scheduler): Future[ActorRef[OAuth2AuthorizationService.Command]] =
//    AkkaUtils.spawn(InMemoryOauth2AuthorizationService(), OAuth2AuthorizationService.Key.id)
//
//  def init()(
//      implicit
//      reactor: RecipientRef[SpawnProtocol.Command],
