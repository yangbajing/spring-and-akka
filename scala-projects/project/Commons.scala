...
object Commons {
  def basicSettings =
    Seq(
      organization := "me.yangbajing.platform",
      organizationName := "yangbajing.me",
      organizationHomepage := Some(url("https://github.com/yangbajing")),
      homepage := Some(url("https://github.com/yangbajing/development")),
      startYear := Some(2020),
...
object Publishing {
  lazy val publishing = Seq(
    ...
    scmInfo := Some(
        ScmInfo(url("https://github.com/yangbajing/development"), "scm:git:git@github.com:yangbajing/development.git")))
